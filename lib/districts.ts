export const DISTRICTS: Record<string, string[]> = {
  ...
  "Aksaray": ["Ağaçören","Aksaray","Eskil","Gülağaç","Güzelyurt","Ortaköy","Sarıyahşi","Sultanhani"],
  ...
  "Çankırı": ["Atkaracalar","Bayramören","Çankırı","Eldivan","Ilgaz","Korgun","Kurşunlu","Orta","Şabanözü","Yapraklı"],
  ...
  "Eskişehir": ["Alpu","Beylikova","Çifteler","Han","İnönü","Mahmudiye","Mihalgazi","Mihalıççık","Odunpazarı","Sarıcakaya","Seyitgazi","Sivrihisar","Tepebaşı"],
  ...
  "Samsun": ["19 Mayıs","Alaçam","Asarcık","Atakum","Ayvacık","Bafra","Canik","Çarşamba","İlkadım","Kavak","Ladik","Ondokuzmayıs","Salıpazarı","Tekkeköy","Terme","Vezirköprü","Yakakent"],
