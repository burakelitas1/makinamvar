...
export default function ReferanslarPage() {
  ...
  return (
    <div>
      ...
      <p className="text-[#475569] text-sm mb-8">Sitede gösterilen müşteri yorumlarını yönetin.</p>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="flex items-center gap-3 pt-6">
            ...
            <label htmlFor="active" className="text-sm text-[#475569]">Sitede göster</label>
          </div>
        </div>
        <div className="mb-4">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl text-center py-10">
          <p className="text-[#475569]">Henüz referans yok. Yukarıdan ekleyin.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {items.map((item) => (
            <div key={item.id} className="bg-white border border-[#E2E8F0] rounded-xl p-5 flex gap-4 items-start">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[#475569] text-sm line-clamp-2">{item.text}</p>
                <p className="text-[#475569] text-xs mt-1">{item.date}</p>
              </div>
