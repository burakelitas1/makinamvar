...
const MACHINE_CATEGORIES = [
  { icon: Layers,    title: 'Abkant Pres',           desc: 'CNC, hidrolik ve pnömatik abkant presler.' },
  { icon: Scissors,  title: 'Giyotin Makas',          desc: 'Hidrolik ve mekanik giyotin kesim makineleri.' },
  { icon: MoveDown,  title: 'Pres Makineleri',        desc: 'Eksantrik, hidrolik ve servo pres sistemleri.' },
  { icon: RefreshCw, title: 'Silindir Makineleri',    desc: 'Sac kıvırma ve silindir bükme makineleri.' },
  { icon: GitBranch, title: 'Boru Büküm Makineleri', desc: 'Boru ve profil şekillendirme sistemleri.' },
  { icon: Zap,       title: 'Testereler',             desc: 'Şerit testere ve metal kesim makineleri.' },
]
  ...
  return (
    <div className="bg-white">
      ...
      <section className="bg-white border-b border-[#E2E8F0]">
        <div className="max-w-[1280px] mx-auto px-6 pt-16 pb-[96px] md:pt-20 md:pb-[96px]">
          ...
          <h1 className="text-[40px] sm:text-[64px] font-extrabold text-[#0F172A] leading-[46px] sm:leading-[72px] tracking-tight mb-5 max-w-2xl">
            Makineniz İçin Teklifinizi Öğrenin.
          </h1>
          <p className="text-[18px] text-[#475569] leading-[30px] mb-10 max-w-[500px] font-normal">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TRUST_ITEMS.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white border border-[#E2E8F0] rounded-[20px] p-8 hover:-translate-y-0.5 hover:shadow-sm transition-all duration-200">
                <div className="w-11 h-11 rounded-xl bg-[#3B5BDB]/8 flex items-center justify-center mb-6">
      ...
      {/* MAKİNE KATEGORİLERİ */}
      <section id="makineler" className="bg-[#F8FAFC] py-[96px]">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="mb-14">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {MACHINE_CATEGORIES.map(({ icon: Icon, title, desc }) => (
              ...
              >
                ...
                <p className="text-[14px] text-[#475569] leading-[22px] mb-6">{desc}</p>
                <span className="text-[14px] text-[#3B5BDB] font-medium inline-flex items-center gap-1.5 group-hover:gap-2.5 transition-all duration-200">
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-[20px] overflow-hidden">
            <div className="grid grid-cols-3 border-b border-[#E2E8F0]">
              <div className="px-6 py-4 text-[12px] font-medium text-[#94A3B8] uppercase tracking-wider"></div>
              <div className="px-6 py-4 text-[12px] font-medium text-[#475569] uppercase tracking-wider text-center border-l border-[#E2E8F0]">İlanla Satış</div>
              <div className="px-6 py-4 text-[12px] font-medium text-[#3B5BDB] uppercase tracking-wider text-center border-l border-[#E2E8F0]">Trink'ten Teklif</div>
            </div>
      ...
      {/* ALT CTA */}
      <section className="bg-[#0F172A] py-[96px]">
        <div className="max-w-[1280px] mx-auto px-6">
